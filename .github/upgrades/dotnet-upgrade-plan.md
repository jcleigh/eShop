...
3. Upgrade EventBus.csproj
4. Upgrade Ordering.Domain.csproj
5. Upgrade IntegrationEventLogEF.csproj
6. Upgrade Ordering.Infrastructure.csproj
7. Upgrade EventBusRabbitMQ.csproj
8. Upgrade eShop.ServiceDefaults.csproj
9. Upgrade WebAppComponents.csproj
10. Upgrade ClientApp.csproj
11. Upgrade Ordering.API.csproj
12. Upgrade Identity.API.csproj
13. Upgrade Catalog.API.csproj
14. Upgrade Basket.API.csproj
15. Upgrade OrderProcessor.csproj
16. Upgrade PaymentProcessor.csproj
17. Upgrade WebhookClient.csproj
18. Upgrade Mobile.Bff.Shopping.csproj
19. Upgrade WebApp.csproj
20. Upgrade Webhooks.API.csproj
21. Upgrade HybridApp.csproj
22. Upgrade Ordering.UnitTests.csproj
23. Upgrade Ordering.FunctionalTests.csproj
24. Upgrade Catalog.FunctionalTests.csproj
25. Upgrade Basket.UnitTests.csproj
26. Upgrade eShop.AppHost.csproj
27. Run unit tests to validate upgrade in the projects listed below:
...
|:---------------------------------------------------|:--------------------------------:|:-----------:|:-----------------------------------------------|
| Aspire.Azure.AI.OpenAI                            | 8.0.0-preview.8.24258.2          | 9.4.1-preview.1.25408.4 | Recommended for .NET 9.0                      |
| Aspire.Hosting.AppHost                             | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Hosting.Azure.CognitiveServices            | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Hosting.PostgreSQL                         | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Hosting.RabbitMQ                           | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Hosting.Redis                              | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Npgsql                                     | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.Npgsql.EntityFrameworkCore.PostgreSQL     | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.RabbitMQ.Client                           | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Aspire.StackExchange.Redis                       | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
...
| Microsoft.Extensions.Http.Resilience             | 8.7.0                           | 9.8.0       | Recommended for .NET 9.0                      |
| Microsoft.Extensions.Identity.Stores             | 8.0.7                           | 9.0.8       | Recommended for .NET 9.0                      |
| Microsoft.Extensions.Logging.Debug               | 8.0.0;8.0.*-*                  | 9.0.8       | Recommended for .NET 9.0                      |
...
| Microsoft.Extensions.ServiceDiscovery             | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
| Microsoft.Extensions.ServiceDiscovery.Yarp       | 8.2.0                           | 9.4.1       | Deprecated version, recommended for .NET 9.0  |
...
Other changes:
  - Remove System.Reflection.TypeExtensions package as functionality is included with framework reference
...
NuGet packages changes:
  - Aspire.RabbitMQ.Client should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
NuGet packages changes:
  ...
  - Microsoft.Extensions.Http.Resilience should be updated from `8.7.0` to `9.8.0` (*recommended for .NET 9.0*)
  - Microsoft.Extensions.ServiceDiscovery should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
Project properties changes:
  - Target framework should be changed from `net8.0-android;net8.0-ios;net8.0-maccatalyst;net8.0;net8.0-windows10.0.19041.0` to `net8.0-android;net8.0-ios;net8.0-maccatalyst;net8.0;net8.0-windows10.0.19041.0;net9.0-windows`
...
NuGet packages changes:
  - Aspire.Npgsql.EntityFrameworkCore.PostgreSQL should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
NuGet packages changes:
  - Aspire.Npgsql.EntityFrameworkCore.PostgreSQL should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.Tools should be updated from `8.0.8` to `9.0.8` (*recommended for .NET 9.0*)
  - Aspire.Azure.AI.OpenAI should be updated from `8.0.0-preview.8.24258.2` to `9.4.1-preview.1.25408.4` (*recommended for .NET 9.0*)
...
NuGet packages changes:
  - Aspire.StackExchange.Redis should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
NuGet packages changes:
  - Aspire.Npgsql should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
NuGet packages changes:
  - Microsoft.Extensions.ServiceDiscovery.Yarp should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
Project properties changes:
  - Target framework should be changed from `net8.0-android;net8.0-ios;net8.0-maccatalyst;net8.0-windows10.0.19041.0` to `net8.0-android;net8.0-ios;net8.0-maccatalyst;net8.0-windows10.0.19041.0;net9.0-windows`
...
NuGet packages changes:
  - Aspire.Hosting.AppHost should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Aspire.Hosting.PostgreSQL should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
...
NuGet packages changes:
  - Aspire.Hosting.AppHost should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Aspire.Hosting.RabbitMQ should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Aspire.Hosting.Redis should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Aspire.Hosting.PostgreSQL should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)
  - Aspire.Hosting.Azure.CognitiveServices should be updated from `8.2.0` to `9.4.1` (*deprecated version, recommended for .NET 9.0*)